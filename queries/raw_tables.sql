...
SET CLIENT_ENCODING TO 'utf8';
 ...
 \COPY artists_raw FROM '../csv/raw/artists/artists.csv' WITH CSV HEADER;
...
\COPY songs_raw FROM '../csv/raw/songs/dataset-of-00s.csv' WITH CSV HEADER;

\COPY songs_raw FROM '../csv/raw/songs/dataset-of-60s.csv' WITH CSV HEADER;

\COPY songs_raw FROM '../csv/raw/songs/dataset-of-70s.csv' WITH CSV HEADER;

\COPY songs_raw FROM '../csv/raw/songs/dataset-of-80s.csv' WITH CSV HEADER;

\COPY songs_raw FROM '../csv/raw/songs/dataset-of-90s.csv' WITH CSV HEADER;

\COPY songs_raw FROM '../csv/raw/songs/dataset-of-10s.csv' WITH CSV HEADER;